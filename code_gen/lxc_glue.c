...
bool set_config_item__glue(struct lxc_container * c, char * a0, char * a1) {
  return (bool)c->set_config_item((struct lxc_container *) c, (const char *) a0, (const char *) a1);
}
...
bool clear_config_item__glue(struct lxc_container * c, char * a0) {
  return (bool)c->clear_config_item((struct lxc_container *) c, (const char *) a0);
}

int get_config_item__glue(struct lxc_container * c, char * a0, char * a1, int a2) {
  return (int)c->get_config_item((struct lxc_container *) c, (const char *) a0, (char *) a1, (int) a2);
}

char * get_running_config_item__glue(struct lxc_container * c, char * a0) {
  return (char *)c->get_running_config_item((struct lxc_container *) c, (const char *) a0);
}

int get_keys__glue(struct lxc_container * c, char * a0, char * a1, int a2) {
  return (int)c->get_keys((struct lxc_container *) c, (const char *) a0, (char *) a1, (int) a2);
}
...
char ** get_ips__glue(struct lxc_container * c, char * a0, char * a1, int a2) {
  return (char **)c->get_ips((struct lxc_container *) c, (const char *) a0, (const char *) a1, (int) a2);
}

int get_cgroup_item__glue(struct lxc_container * c, char * a0, char * a1, int a2) {
  return (int)c->get_cgroup_item((struct lxc_container *) c, (const char *) a0, (char *) a1, (int) a2);
}

bool set_cgroup_item__glue(struct lxc_container * c, char * a0, char * a1) {
  return (bool)c->set_cgroup_item((struct lxc_container *) c, (const char *) a0, (const char *) a1);
}
...
struct lxc_container * clone__glue(struct lxc_container * c, char * a0, char * a1, int a2, char * a3, char * a4, uint64_t a5, char ** a6) {
  return (struct lxc_container *)c->clone((struct lxc_container *) c, (const char *) a0, (const char *) a1, (int) a2, (const char *) a3, (const char *) a4, (uint64_t) a5, (char **) a6);
}
...
int console__glue(struct lxc_container * c, int a0, int a1, int a2, int a3, int a4) {
  return (int)c->console((struct lxc_container *) c, (int) a0, (int) a1, (int) a2, (int) a3, (int) a4);
}

int attach_run_wait__glue(struct lxc_container * c, lxc_attach_options_t * a0, char * a1, char ** a2) {
  return (int)c->attach_run_wait((struct lxc_container *) c, (lxc_attach_options_t *) a0, (const char *) a1, (const char * const *) a2);
}
...
int snapshot_list__glue(struct lxc_container * c, struct lxc_snapshot ** a0) {
  return (int)c->snapshot_list((struct lxc_container *) c, (struct lxc_snapshot **) a0);
}

bool snapshot_restore__glue(struct lxc_container * c, char * a0, char * a1) {
  return (bool)c->snapshot_restore((struct lxc_container *) c, (const char *) a0, (const char *) a1);
}
...
bool add_device_node__glue(struct lxc_container * c, char * a0, char * a1) {
  return (bool)c->add_device_node((struct lxc_container *) c, (const char *) a0, (const char *) a1);
}

bool remove_device_node__glue(struct lxc_container * c, char * a0, char * a1) {
  return (bool)c->remove_device_node((struct lxc_container *) c, (const char *) a0, (const char *) a1);
}

bool attach_interface__glue(struct lxc_container * c, char * a0, char * a1) {
  return (bool)c->attach_interface((struct lxc_container *) c, (const char *) a0, (const char *) a1);
}

bool detach_interface__glue(struct lxc_container * c, char * a0, char * a1) {
  return (bool)c->detach_interface((struct lxc_container *) c, (const char *) a0, (const char *) a1);
}

bool checkpoint__glue(struct lxc_container * c, char * a0, bool a1, bool a2) {
  return (bool)c->checkpoint((struct lxc_container *) c, (char *) a0, (bool) a1, (bool) a2);
}
...
int migrate__glue(struct lxc_container * c, unsigned int a0, struct migrate_opts * a1, unsigned int a2) {
  return (int)c->migrate((struct lxc_container *) c, (unsigned int) a0, (struct migrate_opts *) a1, (unsigned int) a2);
}

int console_log__glue(struct lxc_container * c, struct lxc_console_log * a0) {
  return (int)c->console_log((struct lxc_container *) c, (struct lxc_console_log *) a0);
}
...
int mount__glue(struct lxc_container * c, char * a0, char * a1, char * a2, unsigned long a3, const void * a4, struct lxc_mount * a5) {
  return (int)c->mount((struct lxc_container *) c, (const char *) a0, (const char *) a1, (const char *) a2, (unsigned long) a3, (const void *) a4, (struct lxc_mount *) a5);
}

int umount__glue(struct lxc_container * c, char * a0, unsigned long a1, struct lxc_mount * a2) {
  return (int)c->umount((struct lxc_container *) c, (const char *) a0, (unsigned long) a1, (struct lxc_mount *) a2);
}
